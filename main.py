...
from bandit_algos import RandomAgent, GreedyAgent, EpsilonGreedyAgent, EGDecayAgent, UCBAgent, ThompsonSamplingAgent, SoftMaxAgent
...
sm_agent = SoftMaxAgent(env=env, number_of_pulls=10000) # Default temperature value 0.01
...
agents_performance = [ra_performance, ga_performance, ega_performance, egda_performance,
        ucb_performance, ts_performance, sm_performance]

names = ["Random Agent", 'Greedy Agent', 'epsilon-Greedy Agent', 'epsilon-Greedy Decay Agent', 
        'UCB Agent', 'Thompson Sampling Agent', 'Softmax Agent']
